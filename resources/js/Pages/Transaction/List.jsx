            ...
            <div className="py-12">
                <div className="card">
                    <div className="content">
                        <h3 className="font-bold text-2xl mb-4">My Balance: { thousandSep(balance) }</h3>
                        ...
                        {transactionList.data.map(transaction => (
                            <div key={transaction.id} className="content flex">
                                <div className="w-11/12">
                                    ...
                                    <h5 className={classNames({"mb-2 text-xl font-bold tracking-tight": true, "text-rose-700": transaction.transaction_type == "D", "text-green-700": transaction.transaction_type == "C"})}>{transaction.transaction_type === 'D' ? '-' : '+'} { thousandSep(transaction.amount) }</h5>
                                    ...
                                    <p className="text-xs">Created at: { moment(transaction.created_at).format('LLL') }</p>
                                </div>
